...
टेक्स्ट-टू-स्पीच एक्सटेंशन, जिसमें 48 आवाजें, प्रीसेट और मल्टी-स्पीकर डायलॉग हैं - यह [MCP वॉइस साउंडबोर्ड](https://github.com/mcp-tool-shop-org/mcp-voice-soundboard) द्वारा संचालित है।
...
डायलॉग टैब में एक मल्टी-स्पीकर स्क्रिप्ट लिखें, आवाज़ें असाइन करें, और फिर **एक्सपोर्ट VTT** पर क्लिक करें। एक्सटेंशन प्रत्येक पंक्ति को संश्लेषित करता है, ऑडियो अवधि से संचयी टाइमकोड की गणना करता है, और एक [WebVTT](https://developer.mozilla.org/en-US/docs/Web/API/WebVTT_API) सबटाइटल फ़ाइल सहेजता है।

एक्सपोर्ट की गई `.vtt` फ़ाइल में वॉयस टैग (`<v Speaker>`) का उपयोग किया जाता है और इसे वीडियो प्लेयर, सबटाइटल संपादकों या एक्सेसिबिलिटी टूल के साथ उपयोग किया जा सकता है।
...
| `voiceSoundboard.speed` | `1.0` | स्पीच स्पीड (0.5–2.0) |
...
स्थानीय पायथन मोड (डिफ़ॉल्ट), में सभी स्पीच सिंथेसिस आपके मशीन पर होता है। कोई भी टेक्स्ट कहीं नहीं भेजा जाता है। HTTP मोड में, टेक्स्ट को कॉन्फ़िगर किए गए क्लाउड प्रदाता (OpenAI/ElevenLabs) को उनकी API शर्तों के अनुसार भेजा जाता है। कोई टेलीमेट्री नहीं।

## स्कोरकार्ड

| श्रेणी | स्कोर | टिप्पणियाँ |
|----------|-------|-------|
| A. सुरक्षा | 9/10 | SECURITY.md, केवल स्थानीय, VS Code स्टोरेज में एन्क्रिप्टेड API कुंजियाँ। |
| B. त्रुटि प्रबंधन | 8/10 | बैकएंड ऑटो-स्टार्ट, सुचारू फॉलबैक, स्टेटस संदेश। |
| C. ऑपरेटर दस्तावेज़ | 9/10 | README, CHANGELOG, लैंडिंग पृष्ठ, सेटिंग्स दस्तावेज़। |
| D. शिपिंग स्वच्छता | 9/10 | CI + परीक्षण (102), VS Code मार्केटप्लेस, Codecov कवरेज। |
